...
const { getCourses, createCourse, editCourse, deleteCourse, enrollCourse, accessCourseVideo, addComment, getComments, getCourse } = require('../controllers/courseController');
